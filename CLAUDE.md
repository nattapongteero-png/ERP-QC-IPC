...
### ⚖️ ข้อยกเว้น — เอกสารภาษีตามกฎหมาย "ห้ามแปล"

เอกสารที่กฎหมายกำหนดถ้อยคำไว้ **ต้องเป็นภาษาไทยเสมอ** ไม่ว่าผู้ใช้จะเลือกภาษาอะไร
เพราะข้อความพวกนี้คือ *เนื้อหาตามกฎหมาย* ไม่ใช่ข้อความ UI — แปลแล้วเอกสารใช้ไม่ได้
(ป.รัษฎากร ม.86/4 บังคับคำว่า "ใบกำกับภาษี" "ต้นฉบับ" "สำนักงานใหญ่" "เลขประจำตัวผู้เสียภาษี")

| ไฟล์ | เอกสาร |
|---|---|
| `*PrintDocument.tsx` | ใบกำกับภาษี / ใบเสร็จ / ใบส่งของ |
| `wht-certificate-dialog.tsx` | หนังสือรับรองการหักภาษี ณ ที่จ่าย |
| `reports/vat/page.tsx`, `reports/wht/page.tsx` | ชื่อรายงานภาษีขาย/ภาษีซื้อ (แนบ ภ.พ.30) |

`scripts/claude-done-gate.mjs` มี allow-list ชุดนี้แล้ว (`I18N_EXEMPT`) จะไม่เตือนไฟล์เหล่านี้
ถ้าเพิ่มเอกสารภาษีใหม่ ให้เพิ่มทั้ง 2 ที่ — ตารางนี้และ `I18N_EXEMPT`
