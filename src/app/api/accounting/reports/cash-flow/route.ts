...
import { generateCashFlowStatement } from '@/lib/services/accounting-reports.service';

// GET /api/accounting/reports/cash-flow - Generate Cash Flow Statement (Indirect Method)
  ...
  return withAuth(
    ...
    async () => {
      try {
        ...
        const report = await generateCashFlowStatement(periodStart, periodEnd);
