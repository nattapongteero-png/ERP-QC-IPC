...
import { snoozeNotificationSchema } from '@/lib/validation/equipment-notifications';
import { snoozeNotification } from '@/lib/services/equipment-notification.service';
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  try {
    const updated = await snoozeNotification(nid, parsed.data.snoozeDays, session.userId, parsed.data.note);
