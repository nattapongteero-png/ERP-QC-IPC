...
export default function MasterDataPage() {
  ...
  return (
    <div className="flex flex-col gap-5 p-4 md:p-6 w-full max-w-full overflow-hidden box-border">
      ...
      {/* About section removed — it duplicated the module cards above (each card
          already shows the title, description, and "used in" hint), so a second
          list of the same modules was redundant. */}
