  ...
  return (
    <div className="p-6" data-testid="trial-balance-page" data-title={t('page.title')}>
      ...
      {data && (
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="text-base">{t('reports.trialBalance.chartTitle')}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-64">
      ...
      <Card>
        <CardContent className="p-0">
          ...
          >
            ...
            <Column dataField="category" caption={t('reports.trialBalance.categoryColumn')} groupIndex={0} />
