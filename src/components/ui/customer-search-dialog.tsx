  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
        <DialogHeader className="pb-4 border-b bg-gradient-to-r from-emerald-50 to-teal-50 -mx-6 -mt-6 px-6 pt-6 rounded-t-lg">
        ...
        <div ref={listRef} className="flex-1 overflow-y-auto -mx-6 px-6 py-4 min-h-[300px]">
          {isSearching ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500">Searching customers...</p>
            </div>
          ) : results.length > 0 ? (
