...
const translations: Translations = {
  ...
  investingCashFlow: { en: 'Investing Cash Flow', th: 'กระแสเงินสดจากการลงทุน' },
  financingCashFlow: { en: 'Financing Cash Flow', th: 'กระแสเงินสดจากการจัดหาเงิน' },
  netChangeInCash: { en: 'Net Change in Cash', th: 'การเปลี่ยนแปลงเงินสดสุทธิ' },
  beginningCash: { en: 'Beginning Cash', th: 'เงินสดต้นงวด' },
  endingCash: { en: 'Ending Cash', th: 'เงินสดปลายงวด' },
  freeCashFlow: { en: 'Free Cash Flow', th: 'กระแสเงินสดอิสระ' },
  adjustments: { en: 'Adjustments', th: 'รายการปรับปรุง' },
  workingCapitalChanges: { en: 'Working Capital Changes', th: 'การเปลี่ยนแปลงเงินทุนหมุนเวียน' },
  netCashFromOperating: { en: 'Net Cash from Operating', th: 'เงินสดสุทธิจากการดำเนินงาน' },
  netCashFromInvesting: { en: 'Net Cash from Investing', th: 'เงินสดสุทธิจากการลงทุน' },
  netCashFromFinancing: { en: 'Net Cash from Financing', th: 'เงินสดสุทธิจากการจัดหาเงิน' },
  investingItems: { en: 'Investing Items', th: 'รายการลงทุน' },
  financingItems: { en: 'Financing Items', th: 'รายการจัดหาเงิน' },
  cashReconciliation: { en: 'Cash Reconciliation', th: 'กระทบยอดเงินสด' },
  description: { en: 'Description', th: 'รายละเอียด' },
  otherIncomeExpenses: { en: 'Other Income/Expenses', th: 'รายได้/ค่าใช้จ่ายอื่น' },
  netIncomeBeforeTax: { en: 'Net Income Before Tax', th: 'กำไรก่อนภาษี' },
  incomeTax: { en: 'Income Tax', th: 'ภาษีเงินได้' },
  period: { en: 'period', th: 'งวด' },
