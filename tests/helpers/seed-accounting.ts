...
export const ACCT_TEST_IDS = {
  ...
  WHT_PAYABLE: 205, // 2132 for payments
...
export function seedGLAccounts(sqlite: Database.Database): void {
  sqlite.exec(`
    ...
    VALUES
      ...
      (${ACCT_TEST_IDS.WHT_PAYABLE}, '2132', 'ภาษีหัก ณ ที่จ่ายค้างจ่าย', 'WHT Payable', ${ACCT_TEST_IDS.LIABILITY_TYPE}, NULL, 1, 1, 1, 0, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
